    ...
    return (
      <div style={{ background: 'var(--card)', border: '1px solid var(--border2)', borderRadius: 18, padding: 28 }}>
        ...
        <div style={{ background: 'var(--bluesoft)', border: '1px solid var(--bluesoft2)', borderRadius: 11, padding: 18, textAlign: 'center', marginTop: 22 }}>
          ...
          <div style={{ fontSize: 12, color: 'var(--text2)', marginTop: 3 }}>MAD de chiffre d&apos;affaires mensuel</div>
  ...
  return (
    <div style={{ background: 'var(--card)', border: '1px solid var(--border2)', borderRadius: 18, padding: 28, position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 11, fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--blue)', marginBottom: 18 }}>
        ...
        <div style={{ textAlign: 'center', fontSize: 11, color: 'var(--text2)', paddingTop: 14, borderTop: '1px solid var(--border)', marginTop: 16 }}>
          Remboursement Pack N°2 en{' '}
          <strong style={{ color: 'var(--blue)' }}>{payback} jours</strong>
          {' '}· Marge brute :{' '}
          <strong style={{ color: 'var(--blue)' }}>{margin}%</strong>
        </div>
